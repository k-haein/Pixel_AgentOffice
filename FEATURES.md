...
> 새 기능 추가 시 즉시 갱신.
>
> 최종 갱신: 2026-05-26 (Day 12 §3 +1 — 알림 모달 + 빈 input 강조 + Mary/Haewol/Cody 기본값 자동 채움 + 🤖 Cody 메인 캐릭터 + EXE v0.0.1)
...
| [Day 13 Phase 3](#진급-시스템-day-13--phase-3) | 진급 시스템 (자격 판정 + 진급 요청 모달) |
...
- **정성형**: 받은 칭찬(👍) (사원 1 / 대리 5 / 과장 15 / 부장 40)
- **혼합형**: 위 3개 중 2개 이상 충족
- **수동(off)**: 자동 제안 안 함
...
### 알려진 한계
- 진급 기준 수치는 아직 **코드 하드코딩** — 사용자 설정 불가 (다음: 난이도 배율 설정)
